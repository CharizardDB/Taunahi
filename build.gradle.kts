...
loom {
    launchConfigs {
        "client" {
            ...
            arg("-Dfml.coreMods.load", "com.mozilla.transformer.FMLCore")
            arg("--tweakClass", "com.mozilla.transformer.Tweaker")
        }
    }
    forge {
...
tasks.withType(Jar::class) {
    ...
    manifest.attributes.run {
        this["FMLCorePlugin"] = "com.mozilla.transformer.FMLCore"
