...
public class PlayerUtils {
    ...
    public static TaunahiConfig.CropEnum getFarmingCrop() {
        ...
        if (mc.objectMouseOver != null && mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (mc.theWorld == null) return TaunahiConfig.CropEnum.NONE;
    ...
    public static boolean shouldWalkForwards() {
        ...
        if (MacroHandler.getInstance().getCrop() == TaunahiConfig.CropEnum.CACTUS ||
                (TaunahiConfig.getMacro() != TaunahiConfig.MacroEnum.S_PUMPKIN_MELON_MELONGKINGDE && (MacroHandler.getInstance().getCrop() == TaunahiConfig.CropEnum.PUMPKIN || MacroHandler.getInstance().getCrop() == TaunahiConfig.CropEnum.MELON)) ||
                (MacroHandler.getInstance().getCrop() == TaunahiConfig.CropEnum.COCOA_BEANS && TaunahiConfig.getMacro() == TaunahiConfig.MacroEnum.S_COCOA_BEANS_LEFT_RIGHT))
            return false;
    ...
    public static boolean isStandingOnSpawnPoint() {
        ...
        BlockPos spawnPoint = new BlockPos(TaunahiConfig.spawnPosX + 0.5, TaunahiConfig.spawnPosY + 0.5, TaunahiConfig.spawnPosZ + 0.5);
