package com.mozilla.util.helper;
                ...
                try {
                    ...
                    switch (TaunahiConfig.failsafeSoundSelected) {
                        case 0:
                            ...
                            break;
                        case 1:
                            inputStream = AudioSystem.getAudioInputStream(getClass().getResource("/BufferedCipher/sounds/notification.wav"));
                            break;
                        case 2:
                            inputStream = AudioSystem.getAudioInputStream(getClass().getResource("/BufferedCipher/sounds/pipe.wav"));
                            break;
                        case 3:
                            inputStream = AudioSystem.getAudioInputStream(getClass().getResource("/BufferedCipher/sounds/AAAAAAA2.wav"));
                            break;
                        case 4:
                            inputStream = AudioSystem.getAudioInputStream(getClass().getResource("/BufferedCipher/sounds/buzz.wav"));
                            break;
                    }
                    if (inputStream == null) {
