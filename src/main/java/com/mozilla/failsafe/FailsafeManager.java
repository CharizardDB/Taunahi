package com.mozilla.failsafe;

import cc.polyfrost.oneconfig.utils.Multithreading;
import com.mozilla.config.TaunahiConfig;
import com.mozilla.event.BlockChangeEvent;
import com.mozilla.event.ReceivePacketEvent;
import com.mozilla.failsafe.impl.*;
...
//        if (FeatureManager.getInstance().shouldIgnoreFalseCheck()) return;
    ...
    public void onTickChooseEmergency(TickEvent.ClientTickEvent event) {
        ...
        if (TaunahiConfig.captureClipAfterFailsafe && !TaunahiConfig.captureClipKeybind.getKeyBinds().isEmpty()) {
            if (TaunahiConfig.clipCapturingType) {
