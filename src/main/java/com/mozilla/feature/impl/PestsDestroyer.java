...
public class PestsDestroyer implements IFeature {
    ...
    public void start() {
        ...
        Multithreading.schedule(() -> {
            ...
            if (TaunahiConfig.sendWebhookLogWhenPestDestroyerStartsStops) {
    ...
    public void resetStatesAfterMacroDisabled() {
        stop();
        gotRangeOfVacuum = false;
        if (!TaunahiConfig.pestsDestroyerAfkInfiniteMode) return;
    ...
    public boolean canEnableMacro(boolean manually) {
        ...
        if (GameStateHandler.getInstance().getPestsCount() < TaunahiConfig.startKillingPestsAt && !manually || (manually && GameStateHandler.getInstance().getPestsCount() == 0))
            return false;
        ...
        switch (state) {
            case IDLE:
                ...
                if (needToUpdatePlots || PlotUtils.needToUpdatePlots()) {
                    ...
                    if (TaunahiConfig.dontTeleportToPlots) {
                ...
                if (getLocationTries > 2) {
                    ...
                    if (!isNearPlotCenter()) {
                        if (currentPlot != null) {
                            ...
                            FlyPathFinderExecutor.getInstance().setSprinting(TaunahiConfig.sprintWhileFlying);
                            FlyPathFinderExecutor.getInstance().setDontRotate(false);
                            FlyPathFinderExecutor.getInstance().setUseAOTV(InventoryUtils.hasItemInHotbar("Aspect of the Void", "Aspect of the End"));
            ...
            case CHECK_ANOTHER_PEST:
                ...
                if (closestPest2 != null) {
                    ...
                    if (plotOpt != null) {
                        ...
                        if (distanceToPlot < 150 || TaunahiConfig.dontTeleportToPlots) {
