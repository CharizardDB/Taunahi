...
import com.mozilla.util.OldRotationUtils;
...
public class MovRecPlayer implements IFeature {
    ...
    public MovRecPlayer() {
        ...
        try {
            resourceFiles = getResourceFiles("/BufferedCipher/movrec");
            ...
            for (String file : resourceFiles) {
                ...
                InputStream inputStream = BufferedCipher.class.getResourceAsStream(file);
...
//        LogUtils.sendSuccess("easeTo: " + (movement.yaw + yawDifference));
    ...
    private List<String> getResourceFiles(String path) throws IOException {
        ...
        FileSystem fs;
        URL url = BufferedCipher.class.getResource(path);
        if (url == null) {
            return filenames;
        }
        try {
            ...
            if ("file".equals(uri.getScheme())) {
                myPath = Paths.get(Objects.requireNonNull(BufferedCipher.class.getResource(path)).toURI());
            } else {
