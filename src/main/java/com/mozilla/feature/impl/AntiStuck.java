...
import com.mozilla.failsafe.impl.BadEffectsFailsafe;
import com.mozilla.failsafe.impl.CobwebFailsafe;
import com.mozilla.failsafe.impl.RotationFailsafe;
import com.mozilla.failsafe.impl.TeleportFailsafe;
...
public class AntiStuck implements IFeature {
    ...
    @Override
    public void start() {
        if (enabled || !TaunahiConfig.tmpAntiStuckEnabled) return;
    ...
    public boolean isToggled() {
        return TaunahiConfig.tmpAntiStuckEnabled;
    }
    ...
    public void onTickUnstuck(TickEvent.ClientTickEvent event) {
        ...
        switch (unstuckState) {
            case NONE:
                ...
                break;
            case PRESS:
                if (unstuckTries > TaunahiConfig.antiStuckTriesUntilRewarp) {
