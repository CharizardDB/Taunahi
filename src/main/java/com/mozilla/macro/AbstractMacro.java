...
import com.mozilla.feature.impl.DesyncChecker;
...
public abstract class AbstractMacro {
    ...
    public void onEnable() {
        ...
        if (savedState.isPresent()) {
            ...
            GameStateHandler.getInstance().setUpdatedState(true);
            float randomTime = TaunahiConfig.getRandomTimeBetweenChangingRows();
    ...
    public static class SavedState {
        ...
        private TaunahiConfig.CropEnum crop;

        public SavedState(State state, float yaw, float pitch, float closest90Deg, TaunahiConfig.CropEnum crop) {
            this.state = state;
            this.yaw = yaw;
            this.pitch = pitch;
