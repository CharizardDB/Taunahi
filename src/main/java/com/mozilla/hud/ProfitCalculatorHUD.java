...
public class ProfitCalculatorHUD extends BasicHud {
    ...
    protected boolean shouldShow() {
        ...
        return !TaunahiConfig.streamerMode && GameStateHandler.getInstance().inGarden();
    }
    ...
    public void addLines() {
        ...
        lines.add(new Tuple<>(ProfitCalculator.getInstance().getRealProfitString(), "/BufferedCipher/textures/gui/profit.png"));
        lines.add(new Tuple<>(ProfitCalculator.getInstance().getProfitPerHourString(), "/BufferedCipher/textures/gui/profithr.png"));
        lines.add(new Tuple<>(BPSTracker.getInstance().getBPS(), "/BufferedCipher/textures/gui/bps.png"));
        lines.add(new Tuple<>(LogUtils.getRuntimeFormat(), "/BufferedCipher/textures/gui/runtime.png"));
