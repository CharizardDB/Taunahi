package com.mozilla.remote.struct;
...
public class WebsocketServer extends WebSocketServer {
    ...
    public void onOpen(WebSocket conn, ClientHandshake handshake) {
        ...
        try {
            ...
            JsonObject decoded = BufferedCipher.gson.fromJson(base64Header, JsonObject.class);
    ...
    public void onMessage(WebSocket conn, String message) {
        ...
        RemoteMessage remoteMessage = BufferedCipher.gson.fromJson(message, RemoteMessage.class);
