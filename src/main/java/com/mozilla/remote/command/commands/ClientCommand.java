package com.mozilla.remote.command.commands;
...
import com.mozilla.util.ReflectionUtils;
...
abstract public class ClientCommand {
    ...
    public static void send(RemoteMessage message) {
        WebsocketHandler.getInstance().send(BufferedCipher.gson.toJson(message));
    }
